...
def set_peak_list_rel_int(spec_uni,max_value):
...
def remove_precursor_peak_from_spectrum_uni(spec_uni , mz_range):
    #
    ...
    if(  len (spec_uni.peak_list_mz_int_abs ) > 0):
        ...
        spec_uni.peak_list_mz_int_rel = get_peak_list_rel_int (new_peaklist_mz_int_abs, 999)
...
def set_topN_most_intense_peak_list_in_binned_rangesW( spec_uni_obj, top_n , bin_range_w):
    ...
    set_peak_list_rel_int(spec_uni_obj,999)
